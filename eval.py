...
def main():
    ...
    for item in eval_questions:
        ...
        result = run_turn(item["question"], thread_id=f"eval-{item['id']}-{uuid.uuid4()}")
    ...
    print(f"Avg faithfulness (1-5):    {statistics.mean(faith_scores):.2f}" if faith_scores else "Avg faithfulness: n/a")
    print(f"Avg relevancy (1-5):       {statistics.mean(rel_scores):.2f}" if rel_scores else "Avg relevancy: n/a")
